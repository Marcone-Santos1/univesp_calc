      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-6 bg-blue-50 dark:bg-gray-800 rounded-lg">
            <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Calculadora de Média
              Final</h3>
          ...
          <div className="p-6 bg-blue-50 dark:bg-gray-800 rounded-lg">
            <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Cálculo da Média com
              Exame</h3>
